...
public class DatabaseHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAVN = "birthdays.db";
    ...
    private static final String CREATE_TABLE_TASKS =
            "CREATE TABLE " +
                    BIRTHDAY_LIST+
                    "(" + KOLONNE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + KOLONNE_BIRTHDAY_NAME + KOLONNE_BIRTHDAY_NUMBER + KOLONNE_BIRTHDAY_DATE +" TEXT NOT NULL)";
